...
api = Namespace("Patient Medication IOT API", description="The generic api endpoints")


class IOTMedication(object):
    def __init__(self):
        self.data = dict
    ...
    def create(self, device_id, operation):
        response = es.index(index="medication-index", doc_type="medi")
        return response
